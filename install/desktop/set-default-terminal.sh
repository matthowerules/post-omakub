...
# Adding gnome-terminal to nautilus contextual menu requires the python wrapper for the libraries
sudo apt install -y python3-nautilus
mkdir -p ~/.local/share/nautilus-python/extensions/

cat > ~/.local/share/nautilus-python/extensions/open-terminal.py <<TECHNICALLYNOTACONFIGSOHEREDOCCEDITIS
import os
